...
public class Merchandise : MonoBehaviour
{
    ...
    void InitializeItemData()
    {
        ...
        {
            new ItemData("Health Potion", null, new int[] {1, 2, 3}, null, "체력을 회복합니다. 레벨에 따라 회복량이 증가합니다.", 1001, "포션"),
            new ItemData("Strength Potion", null, new int[] {2, 3, 4}, null, "공격력을 일시적으로 강화합니다. 레벨에 따라 강화량이 증가합니다.", 1002, "포션"),
            new ItemData("Iron Sword", null, new int[] {3, 4, 5}, null, "철제 검으로 적을 공격합니다. 레벨에 따라 공격력이 증가합니다.", 2001, "무기")
        };
    }
...
public class ItemData
{
    ...
    public ItemData(string name, Sprite image, int[] amounts, Sprite[] images, string desc, int cd, string cat)
    {
        itemName = name;
        itemImage = image;
